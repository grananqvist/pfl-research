...
blobby s3 cp s3://pfl-research-asr-data/federated-en-train.hdf5 ~/.cache/mlx.data/cv-v13/ --quiet
blobby s3 cp s3://pfl-research-asr-data/federated-en-dev.hdf5 ~/.cache/mlx.data/cv-v13/ --quiet
blobby s3 cp s3://pfl-research-asr-data/federated-en-test.hdf5 ~/.cache/mlx.data/cv-v13/ --quiet
